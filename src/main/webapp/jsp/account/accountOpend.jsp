            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/quote1.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div> 
                <div class="col-lg-6 quote-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        <div class="section-title text-start">
                            <h1 class="display-5 mb-4">계좌개설</h1>
                        </div>
                        <p class="mb-4 pb-2">
                        당신의 계좌를 개설해보세요.
                        </p>
						<form action="${ pageContext.request.contextPath }/accountOpendProcess.do" method="post">
						     <div class="row g-3">
						         <div class="col-12">
						             <input type="password" name="accountPW" class="form-control border-0" placeholder="계좌 비밀번호" style="height: 55px;">
						         </div>
						         <div class="col-12">
						             <input type="text" name="balance" class="form-control border-0" placeholder="개설금액" style="height: 55px;">
						         </div>
						         <div class="col-12">
						             <input type="text" name="accountAlias" class="form-control border-0" placeholder="계좌별칭" style="height: 55px;">
						         </div>
						   
						         <div class="col-12">
						             <button class="btn btn-primary w-100 py-3" type="submit">계좌개설</button>
						         </div>
						     </div>
						 </form>
                	</div>
